...
1. LOAD the FULL agent file from {project-root}/_bmad/tea/agents/tea.agent.yaml
2. READ its entire contents - this contains the complete agent persona, menu, and instructions
3. LOAD the config from {project-root}/_bmad/tea/config.yaml and store ALL fields as session variables
